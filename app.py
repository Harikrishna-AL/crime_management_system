...
def admin_tab():
    ...
    with st.expander("Create Police Station"):
    ...
    with st.expander("Delete Police Station"):
    ...
    with st.expander("Create Officer"):
    ...
    with st.expander("Get Officer Data"):
    ...
    with st.expander("Update Officer"):
    ...
    with st.expander("Delete Officer"):
    ...
    st.header("FIR Operations")

    with st.expander("Create FIR"):
    ...
    with st.expander("Read FIRs"):
        if st.button("Get All FIRs", key="admin_get_firs"):
            firs = get_data("firs")
            st.write(firs)
    
    st.header("Investigation Operations")

    # Create Investigation
    with st.expander("Create Investigation"):
    ...
    with st.expander("Update Investigation"):
    ...
    with st.expander("Delete Investigation"):
    ...
    st.header("Crime Operations")

    # Create Crime
    with st.expander("Create Crime"):
    ...
    # Read Crimes
    with st.expander("Read Crimes"):
        if st.button("Get All Crimes"):
            crimes = read_crimes()
            st.write(crimes)

    # Read Specific Crime
    with st.expander("Read Specific Crime"):
    ...
    st.header("Criminal Operations")

    # Create Criminal
    with st.expander("Create Criminal"):
    ...
    # Update Criminal
    with st.expander("Update Criminal"):
    ...
    with st.expander("Lookup Criminal"):
    ...
    # Delete Criminal
    with st.expander("Delete Criminal"):
    ...
    st.header("Investigation Officer Operations")

    # Create Investigation Officer
    with st.expander("Create Investigation Officer"):
    ...
    with st.expander("Read Investigation Officers"):
    ...
    with st.expander("Read Specific Investigation Officer"):
    ...
    with st.expander("Delete Investigation Officer"):
    ...
    st.header("Crimes Involved Operations")

    # Create Crimes Involved
    with st.expander("Create Crimes Involved"):
    ...
    with st.expander("Read Crimes Involved"):
    ...
    with st.expander("Read Specific Crimes Involved"):
    ...
    with st.expander("Delete Crimes Involved"):
    ...
    # st.header("Part Of Operations")

    # # Create Part Of
    # with st.expander("Create Part Of"):
    ...
    # # Delete Part Of
    # with st.expander("Delete Part Of"):
